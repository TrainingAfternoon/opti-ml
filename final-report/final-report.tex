...
% TODO: should explain linux perf here!
...
We trained an XGBoost Random Forest model in lieu of a deep neural network. We empirically found that the Random Forest model fit the data better than a deep regression network. %TODO: explain random forest more!
...
\include{cpp-perf-results-table.tex}
