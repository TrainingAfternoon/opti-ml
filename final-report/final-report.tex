...
\item\textbf{action}$\mathcal{S}$: \{0, 1\} where 1 = inline, and 0 = do not inline
...
% TODO: I should probably come back and explain the full PPO if I have the same space
...
% TODO: actually give stats on the dataset here!
