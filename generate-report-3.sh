...
REPORT_FILE="$RESULTS_DIR/base-clang-2-cpp-perf-benchmarks.log"
NUMA_CPU=3
for i in {1..5}
do
    #REPORT_FILE="$RESULTS_DIR/policy-2-cpp-perf-benchmarks.log" \
    #NUMA_CPU=6 \
    #    make -k report-thin
...
for i in {1..5}
do
    export BENCH_RESULTS_FILE=$RESULTS_DIR/base-clang-2-cBench-benchmarks.log
